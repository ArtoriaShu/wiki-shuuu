...
<div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem; border: 1.5px dashed #C8CAD1; border-radius: 10px; padding: 1rem 1.25rem;">
<div>

单击下载 `install.bat`，双击运行即可以管理员权限安装工具。

支持：**PixPin**、**EcoPaste**、**Pot**、**Everything**、**InputTips**
...
<img src="/divider-line-custom.svg" style="width:100%;height:12px;object-fit:contain;" alt="" />
